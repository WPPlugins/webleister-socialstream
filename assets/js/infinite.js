(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($social_stream.length) {
            ...
            $social_stream.append('<div id="social_stream_loading" style="display:none"><img src="' + wl_socialstream_infinite.folder + 'webleister-socialstream/assets/img/loader.gif" alt="Loading..." style="width:25%;margin:0 auto;display:block;"/></div>');
